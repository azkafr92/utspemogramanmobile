...
public class BookkeeperIncomeFragment extends Fragment {
  private ArrayList<TransactionModel> transactionModelArrayList;

  public BookkeeperIncomeFragment() {
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    ViewGroup root = (ViewGroup) inflater.inflate(R.layout.fragment_bookkeeper_income, container, false);
    ...
    RecyclerView rv = (RecyclerView) root.findViewById(R.id.income_transaction_view);
  ...
  private ArrayList<TransactionModel> retrieveData() throws ParseException {
    ...
    db.openDB();
    Cursor c = db.getIncomeTransactions();
